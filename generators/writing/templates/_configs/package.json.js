...
module.exports = function (generator) {
  ...
  const major =
    (specs.overrides || {}).engineNodeMajor || semver.major(process.version)
  ...
  pkg.scripts = Object.assign(
    ...
    specs.options.ts
      ? {
        ...
        tslint:
            'tslint -p tsconfig.json -c tslint.json && tslint -p tsconfig.test.json -c tslint.json',
        ...
        mocha:
            'ts-mocha -p tsconfig.test.json "test/**/*.test.ts" --timeout 10000 --exit',
