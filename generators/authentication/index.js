...
module.exports = class AuthGenerator extends Generator {
  async prompting () {
    ...
    const ifStrategy = value =>
      specs.authentication &&
      specs.authentication.strategies &&
    ...
    const prompts = [
      ...
      },
      {
        ...
        default:
          (specs.authentication && specs.authentication.entity) || 'users'
      }
    ]
