...
module.exports = class AppGenerator extends Generator {
  async prompting () {
    ...
    props.src =
      specs.app.src ||
      (this.pkg.directories && this.pkg.directories.lib) ||
      'src'
    props.description =
    ...
    const prompts = [
        ...
        choices: [
          {
            name: 'REST',
            value: 'rest',
            checked: specs.app.providers
              ? specs.app.providers.indexOf('rest') !== -1
              : true
          },
          {
            ...
            value: 'socketio',
            checked: specs.app.providers
              ? specs.app.providers.indexOf('socketio') !== -1
              : true
          },
          {
            ...
            value: 'primus',
            checked: specs.app.providers
              ? specs.app.providers.indexOf('primus') !== -1
              : false
          }
        ],
        validate (input) {
      ...
      },
      {
        name: 'seedData',
        message:
          'Seed data records on startup when command line includes --seed?',
        type: 'confirm',
    ...
    return this.prompt(prompts).then(answers => {
      ...
      answers.seedData = answers.environmentsAllowingSeedData
        ? answers.seedData
        : false
