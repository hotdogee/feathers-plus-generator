...
module.exports = function jsonSchemaRunner (options) {
  ...
  Object.keys(specs.services).forEach(name => {
    ...
    assert.deepEqual(
      typescriptTypes,
      expectedTypescriptTypes[name],
      'typescriptTypes wrong'
    )
    assert.deepEqual(
      typescriptExtends,
      expectedTypescriptExtends[name],
      'typescriptExtends wrong'
    )
    ...
    assert.deepEqual(
      mongoJsonSchema,
      expectedMongoJsonSchema[name],
      'mongoJsonSchema wrong'
    )
    ...
    assert.deepEqual(
      mongooseSchema,
      expectedMongooseSchema[name],
      'mongooseSchema wrong'
    )
