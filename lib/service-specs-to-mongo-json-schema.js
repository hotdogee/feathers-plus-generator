...
module.exports = function serviceSpecsToMongoJsonSchema (
  feathersSpec,
  feathersExtension,
  depth = 1
) {
  ...
  const mongoProperties = {
    _id: {
      // An _id property in name.schema.js can add properties to this
      bsonType: 'objectId'
    }
  }
  ...
  Object.keys(properties).forEach(name => {
    ...
    switch (property.type) {
      case 'object':
        mongoProperties[name] = serviceSpecsToMongoJsonSchema(
          property,
          feathersExtension,
          ++depth
        )
      ...
      default:
        ...
        mongoProperty.bsonType =
          schemaTypesToMongo[property.type] || property.type
