module.exports = {
  // Configuration for faking data for services.
  fakeData: {
    // Number of records to generate if a JSON-schema does not have a fakeRecords property.
    ...
    jsf: {
      ...
      // random: () => (),
      // A decimal number from 0 to 1 indicating the probability to fake a non-required object property.
      // When 0.0, only required properties will be generated; when 1.0, all properties are generated.
