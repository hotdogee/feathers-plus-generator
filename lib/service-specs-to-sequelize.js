...
module.exports = function serviceSpecsToSequelize (
  feathersSpec,
  feathersExtension
) {
  ...
  obj.properties = traverse(obj.properties).map(function (value) {
  ...
  // inspector('obj out=', obj.properties);
  ...
  Object.keys(obj.properties || {}).forEach(name => {
    ...
    if ('default' in property) {
      seqModel[name].defaultValue = property.default
    }
  })
